...
<a class="card variant-primary card-hover w-64 overflow-hidden" href="/elements/cards">
	<header>
		<img src={bobr} alt="Post" />
	</header>
	...
	<footer class="flex items-center justify-start space-x-4 p-4">
		<Avatar initials="{item.initials}" width="w-8" />
		<div class="flex flex-auto items-center justify-between">
			<h6 class="font-bold" data-toc-ignore>{item.seller}</h6>
