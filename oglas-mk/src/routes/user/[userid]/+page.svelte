...
<AppBar><div class="user-info">
	...
	<div style="width:fit-content;"  class="flex h-full items-start justify-start flex-wrap">
		{#each items as item}
		{#if item.seller==lastPartOfURL}
		<div style="width: 250px;" class="flex h-full items-start justify-start gap-3 flex-wrap px-4">
			<Card {item}/>
		</div>	
		{/if}
		{/each}
